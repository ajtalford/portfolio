...
(function($, undefined) {
  ...
  $.typeIt.prototype = {
    ...
    /*
      Pass string, and loop over string until empty.
    */
    type: function(string, rake) {
      ...
      // rake for HTML tags if designated
      if (rake) {
    ...
    /*
    If show cursor enabled, move array starting point for for loop back one, so loop wont find closing tag and delete cursor.
  */
    ...
    /*
      Advance function queue to execute next function after previous one has finished.
    */
    _executeQueue: function() {
      if (this.queueIndex < this.queue.length) {
        ...
        // delay execution if looping back to beginning of queue.
    ...
    /*
    Convert each string in array to a sub-array. While happening, search subarrays for HTML tags.
    When a complete tag is found, slice subarray to get complete tag, insert it at correct index,
    and delete range of indexes where indexed tag used to be.
    */
    ...
    /*
      Get start & ending positions of string inside HTML opening & closing angle brackets,
